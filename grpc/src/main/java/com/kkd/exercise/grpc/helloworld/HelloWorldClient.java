package com.kkd.exercise.grpc.helloworld;
...
public class HelloWorldClient {
	...
	public HelloWorldClient(Channel channel) {
		...
		// Passing Channels to code makes code easier to test and makes it easier to reuse 
		// Channels.
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length > 0) {
			if ("--help".equals(args[0])) {
				...
				System.err.println("");
				System.err
					.println("  name    The name you wish to be greeted by. Defaults to " + user);
