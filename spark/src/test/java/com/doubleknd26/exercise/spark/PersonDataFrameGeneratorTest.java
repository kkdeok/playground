...
import com.doubleknd26.exercise.spark.model.Person;
import com.doubleknd26.exercise.spark.model.Sex;
...
public class PersonDataFrameGeneratorTest {
     ...
     * (com.doubleknd26.exercise.spark.model.Sex) cannot be converted
     * to the string type
     */
